...
<head>
    ...
    <title>Shree &#8211; College &amp; of Management</title>

    <meta name="description" content="Shree College of management is a dynamic, innovative and quality oriented educational institution offering the students a world class education by providing learning experience designed to develop intellectual abilities as well as social and ethical values. Shree College is located inside the city with well connectivity from all the directions.">
    <meta name="keywords" content="Shree College of Management, Nepal Management College, Shree College Nepal, Nepal Shree College, Nepal ACCA Collage,Nepal CIMA Collage  ">
    ...
    <!-- Popup embaed code -->
 <script id='pixel-script-poptin' src='https://cdn.popt.in/pixel.js?id=037ad2699cfc8' async='true'></script>
    <!-- Popup embaed end -->
</head>
            ...
            <div class="kingster-mobile-header-container kingster-container clearfix">
                <div class="kingster-logo  kingster-item-pdlr">
                    <div class="kingster-logo-inner">
                        <a class="" href="index.php"><img src="{{ asset('assets/images/logo.png') }}" alt="" /></a>
                    </div>
                </div>
               ...
               @include('public/layouts/menuMobile') ;
